...
/**
 * This class is the main executor class which pass all the parameters and configurations to each testcase
 * @author MukeshR
 */
public class Config
{
	...
	public Config()
	{
		...
		if (!StringUtils.isEmpty(url))
			putRunTimeProperty("Url", url);
		if (!StringUtils.isEmpty(username))
			putRunTimeProperty("Username", username);
		if (!StringUtils.isEmpty(password))
			putRunTimeProperty("Password", password);
